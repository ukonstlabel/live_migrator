...
/**
 * Probe-only second implementation of {@link User}, used to pre-warm the hot call sites in
 ...
 * loads guarded by a class-hierarchy-analysis (CHA) assumption. Loading a second implementor
 ...
 *
 * <p>Enabled only via {@code -Dservice.prewarm=bi|mega}; unused otherwise.
 *
 * @see Decoy2User
 */
public class DecoyUser implements User {
    public final int id;
    public final String name;

    public DecoyUser(int id, String name) { this.id = id; this.name = name; }

    @Override public int getId() { return id; }
    @Override public String getName() { return name; }
    @Override public String toString() { return "DecoyUser{id=" + id + "}"; }
}
